...
function addTask() {
  ...
  function saveData() {
      ...
      localStorage.setItem("data2", progressList.innerHTML);
      localStorage.setItem("data3", doneList.innerHTML);
      localStorage.setItem("data4", backlogList.innerHTML);
  }
  
  function showTasks() {
      taskList.innerHTML = localStorage.getItem("data1");
      progressList.innerHTML = localStorage.getItem("data2");
      doneList.innerHTML = localStorage.getItem("data3");
      backlogList.innerHTML = localStorage.getItem("data4");
  }
